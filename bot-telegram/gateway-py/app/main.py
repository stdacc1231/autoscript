...
from .auth import (
    AUTOSCRIPT_LICENSE_BIN,
    AUTOSCRIPT_LICENSE_PORTAL_URL,
    check_runtime_license_blocking_message,
    check_runtime_license_blocking_message_sync,
...
def _license_block_message(raw_output: str) -> str:
    return license_block_message(raw_output)


def _check_runtime_license_blocking_message_sync() -> str:
    return check_runtime_license_blocking_message_sync()


async def _check_runtime_license_blocking_message() -> str:
    return await check_runtime_license_blocking_message()
...
def _is_authorized(runtime: Runtime, update: Update) -> tuple[bool, str]:
    return _auth_is_authorized(runtime.config, update)
