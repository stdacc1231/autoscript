...
func TestRefreshDiscoveredRawBackendsOverridesLoopbackTargets(t *testing.T) {
  ...
  "inbounds": [
    ...
    {"tag": "default@vmess-tcp", "listen": "127.0.0.1", "port": 33176},
	...
	if refreshed.VMessRawBackend != "127.0.0.1:33176" {
		t.Fatalf("VMessRawBackend = %q, want 127.0.0.1:33176", refreshed.VMessRawBackend)
	}
